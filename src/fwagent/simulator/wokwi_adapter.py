...
class WokwiAdapter(Simulator):
    ...
    Generates diagram.json, wokwi.toml, and scenario files, and runs Wokwi CLI or Host-HAL fallback.
    """
    ...
    def generate_wokwi_artifacts(self, out_dir: str) -> Dict[str, str]:
        ...
        diagram = {
            ...
            "parts": [
                ...
                {"type": "wokwi-fan", "id": "fan1", "top": 100, "left": 200},
